...
const ContactForm = () => {
    return (
        <>
            <section id='contactForm' className="relative z-10 overflow-hidden bg-white py-20 px-5 md:px-10 md:mx-auto md:rounded-lg">
                <div className="container mx-auto">
                    <div className="flex flex-wrap -mx-4 lg:justify-between">
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0 bg-white rounded-lg">
                                <span className="block mb-4 text-blue-500 text-base font-semibold text-primary">
                                    Contact Us
                                </span>
                                <h2
                                ...
                                <p
                                    className="text-base leading-relaxed text-gray-500 dark:text-dark-6 mb-9"
                                >
                                    Ready to elevate your golfing experience? Connect with us today to tee off on an unforgettable journey across Vancouver's greens.
                                </p>
                            ...
                            >
                                <form
                                    ...
                                    <div>
                                        <button
                                            type="submit"
                                            className="w-full p-3 text-blue-500 transition border rounded border-primary bg-primary hover:bg-gray-100"
                                        >
                                            Send Message
                                        </button>
                                    </div>
