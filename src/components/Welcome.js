        ...
        <>
            <section id='about' className="flex flex-col justify-center items-center mt-10 mb-32 px-2 md:flex-row md:mt-32">
                ...
                <div className='flex flex-col justify-center items-center z-10'>
                    ...
                    <p className='about-text max-w-[500px] text-white text-start px-3 z-10 mb-10 '>
            ...
            <section className='flex flex-col md:flex-row'>
                <div className='absolute md:static text-start text-white px-5 pt-10 z-10 mx-auto'>
                    <p className='about-text uppercase text-5xl font-bold text-start mb-5'>
                        Welcome
                    </p>
                    <p className='text-white text-sm mb-2'>
                        To one of the best clubs UBC has to offer. 
                    </p>
                    <p className='text-white text-sm md:w-[500px] mb-2'>
                    ...
                    <p className='hidden text-white text-sm md:block md:w-[500px] mb-2'> 
                ...
                <img className='md:w-[500px] md:pt-10 m-auto opacity-75 border-b border-green-neon border-b-4' src={friends} alt='friends'></img>
            </section>
        </> 
    );
};
